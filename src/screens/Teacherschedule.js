...
import { StyleSheet, Text, View, Pressable, TouchableOpacity, alert, Alert } from 'react-native';
...
const Teacherschedule = ({ navigation }) => {
  ...
  const list = ["dsa-402", "idm-326", "isl-03", "oop-302", "pdc-502", "pf-101", "mgt-291","dbs-400"]
    ...
    return (
      <View style={StyleSheet.container}>
        ...
        <View style={styles.dropdown}>
          ...
          {/* <SelectDropdown style={{ alignItems: "center", justifyContent: "center", fontSize: 30, backgroundColor: 'blue' }}
            ...
            buttonTextAfterSelection={(selectedCourse) => {
